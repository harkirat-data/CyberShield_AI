...
Write-Host "[CyberShield AI] Installing argus-auth service..." -ForegroundColor Cyan
...
& $NssmPath set argus-auth DisplayName "CyberShield AI Auth Collector"     | Out-Null
...
Write-Host "[CyberShield AI] Installing argus-system service..." -ForegroundColor Cyan
...
& $NssmPath set argus-system DisplayName "CyberShield AI System Collector"  | Out-Null
